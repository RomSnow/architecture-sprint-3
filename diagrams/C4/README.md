...
### Dynamic diagram
  ...
  -  All relationship macros are extended with `?index= `:
     ...
     > A full sample see [samples/C4_Dynamic Diagram Sample - message bus.puml](samples/C4_Dynamic Diagram Sample - message bus.puml)
...
Source: [C4_Container Diagram Sample - techtribesjs.puml](samples/C4_Container Diagram Sample - techtribesjs.puml)
...
Source: [C4_Container Diagram Sample - message bus.puml](samples/C4_Container Diagram Sample - message bus.puml)
...
Source: [C4_Sequence Diagram Sample - complex.puml](samples/C4_Sequence Diagram Sample - complex.puml)
